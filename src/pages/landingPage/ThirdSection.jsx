...
// assets
import ponnadikkal_jeeyar from "../../assets/img/landingPage/ponnadikkal_jeeyar.png";
...
const ThirdSection = () => {
  return (
    <section className="bg-[#FFE600] pt-10 flex gap-5 flex-col md:flex-row border-b-[9px] border-[#942200]">

...
// media assets
import img2 from "../../assets/img/templeHistory/img2.png";

const ThirdSection = () => {
  return (
    <section className="bg-[#FF8D07] py-20">
      <div className="w-[85%] mx-auto">
        <h1 className="text-4xl uppercase text-center md:text-left">
          Nammalwar & Saranagathi
        </h1>

        <div className="mt-10 flex justify-between items-center gap-5 flex-col md:flex-row-reverse">
          <div className="flex-1">
            <img src={img2} alt="" className="ml-auto" />
          </div>

          <div className="flex-1">
            <p className="font-caladea text-center md:text-left">
